...
<body>
    ...
    <section class="wishlist">
        ...
        <div class="wishlist-total">
            <p>Tổng tiền thanh toán : <span>$<?php echo $grand_total; ?>/-</span></p>
            <a href="shop.php" class="option-btn">Tiếp tục mua</a>
            <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1) ? '' : 'disabled' ?>" onclick="return confirm('delete all from wishlist?');">Xoá tất cả</a>
        </div>
