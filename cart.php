...
<body>
    ...
    <section class="shopping-cart">
        ...
        <div class="box-container">
            ...
            ?>
                    <div class="box">
                        ...
                        <div class="sub-total"> Tổng tiền : <span>$<?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
                    </div>
            <?php
        ...
        <div class="more-btn">
            <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1) ? '' : 'disabled' ?>" onclick="return confirm('delete all from cart?');">Xoá tất cả</a>
        </div>

        <div class="cart-total">
            <p> Tổng tiền : <span>$<?php echo $grand_total; ?>/-</span></p>
