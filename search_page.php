        ...
        <div class="box-container">
            ...
            ?>
                        <form action="" method="POST" class="box">
                            ...
                            <input type="submit" value="Thêm vào giỏ hàng" name="add_to_wishlist" class="option-btn">
                            <input type="submit" value="Thêm thanh toán" name="add_to_cart" class="btn">
                        </form>
            <?php
                    }
                } else {
                ...
                echo '<p class="empty">Tìm kiếm tất cả sản phẩm</p>';
            }
            ?>
